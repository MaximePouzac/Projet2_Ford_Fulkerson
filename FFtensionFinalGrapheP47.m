...
NPRED = uint16([4 1 2 1 3 1 2 5 3 3]);
n = size(NSUC,2);
X = uint16(1:n);
m = sum(NSUC);
%
% Vecteur des successeurs de chaque sommet
SUC = uint16([2 3 4 5 6 7 8 3 5 7 8 9 8 9 10 5 9 10 1 8 1 1 8 10 1]);
%
% Vecteur des predecesseurs de chaque sommet
PRED = uint16([7 8 9 10 1 2 4 2 2 4 6 2 3 4 3 4 5 7 9 4 5 6 5 6 9]);
%
% Vecteur des flots maximaux de chaque arc (en regardant les sucesseurs)
FlMaxSUC = [inf 10 20 10 10 8 4 3 5 5 7 3 6 1 7 6 5 2 2 10 10 3 5 20 10];
% Vecteur des flots maximaux de chaque arc (en regardant les sucesseurs)
FlMaxPRED = [10 10 20 10 inf 10 4 20 10 5 4 10 8 5 4 7 6 2 3 3 1 5 7 2 5];
%
